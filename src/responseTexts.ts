...
🎥 link 3?`,
  ...
  buyTour: `✅ Отлично! Stop-motion тур - это великолепное вложение, которое обычно <b>окупает себя за несколько дней</b>! Уникальность обзоров состоит в том, что инвестируете вы один раз - а <b>приносить доход они вам будут годами!</b> 💵
...
⬇️ Нажмите на кнопку на клавиатуре, чтобы отправить свой номер телефона или <a href="https://t.me/@empflow">напишите мне напрямую</a>`,
